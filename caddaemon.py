...
########################################################################
# Name:
# 		caddaemon.py  (the daemon class for the CodeAutoDeploy.py)
# Description:
# 		Deamonize the the python class
# Author:
...
import time
import signal
import codeautodeploy

class SAUDaemon(object):
    """
    ...
    def run(self):
        ...
        """
        serviceAutoUpdate = codeautodeploy.ServiceAutoUpdate()
        serviceAutoUpdate.run()
        raise NotImplementedError

# ======================begin the main funtion===========================#
sauDeamon = SAUDaemon('pid.pid')
sauDeamon.start()